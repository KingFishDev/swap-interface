...
export const ALLOWED_PRICE_IMPACT_MEDIUM: Percent = new Percent(JSBI.BigInt(1000), BIPS_BASE) // 10%
export const ALLOWED_PRICE_IMPACT_HIGH: Percent = new Percent(JSBI.BigInt(5000), BIPS_BASE) // 50%
// if the price slippage exceeds this number, force the user to type 'confirm' to execute
export const PRICE_IMPACT_WITHOUT_FEE_CONFIRM_MIN: Percent = new Percent(JSBI.BigInt(5000), BIPS_BASE) // 50%
// for non expert mode disable swaps above this
export const BLOCKED_PRICE_IMPACT_NON_EXPERT: Percent = new Percent(JSBI.BigInt(8000), BIPS_BASE) // 80%
...
export const DEFAULT_TOKEN_LIST_URL = 'https://tokens.thugs.fi/tokens.json'
